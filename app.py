 ...
 {'book_id': 'chinese-for-technical-product-managers',
  ...
  'chapters': [{'chapter_id': 'Mika-bedtime',
                ...
                'content': '\n'
                           ...
                           '\n'
                           '\n'
                           'น้องมีก้าคะ คุณครูบอกว่า ให้น้องมีก้านอนให้ไว '
                           ...
                           '\n'
                           'คืนนี้น้องมีก้าทำทุกอย่างให้เสร็จเร็ว ๆ นะคะ อาบน้ำให้สะอาด แปรงฟันให้สะอาด '
                           'ใส่ชุดนอน แล้วขึ้นเตียง\n'
                           '\n'
                           'ก่อนนอนเราสามารถเลือกนิทานหนึ่งเรื่อง แล้วคุณแม่จะอ่านให้น้องมีก้าฟัง\n'
                           '\n'
                           'พออ่านนิทานจบ เราจะปิดไฟ หลับตา และพักผ่อนให้ร่างกายแข็งแรง\n'
                           '\n'
                           'ถ้าน้องมีก้านอนเร็ว พรุ่งนี้ตอนเช้าน้องมีก้าจะตื่นมาสดชื่น มีแรงไปโรงเรียน '
                           'มีแรงเล่นกับเพื่อน และมีแรงเรียนรู้สิ่งใหม่ ๆ\n'
                           '\n'
                           'คุณครูจะดีใจที่น้องมีก้าพักผ่อนเพียงพอ\n'
                           '\n'
                           'คุณแม่ก็จะดีใจเหมือนกัน เพราะน้องมีก้ากำลังเรียนรู้ที่จะดูแลตัวเอง\n'
                           '\n'
               ...
               {'chapter_id': 'Mika-can-do-it',
                'chapter_title': 'น้องมีก้าทำเองได้',
                'order': 2,
                'content': 'น้องมีก้าโตขึ้นทุกวันแล้วนะคะ และมีหลายอย่างที่น้องมีก้าสามารถทำเองได้\n'
                           '\n'
                           'ตอนเช้า เมื่อตื่นขึ้นมา น้องมีก้าลุกจากเตียง เก็บหมอน แล้วเดินไปล้างหน้า\n'
                           '\n'
                           'จากนั้นน้องมีก้าแปรงฟันและเตรียมตัวไปโรงเรียน\n'
                           '\n'
                           'ถ้ามีบางอย่างที่ยังทำไม่ได้ น้องมีก้าสามารถพูดว่า\n'
                           '\n'
                           ...
                           '\n'
                           'ที่โรงเรียน ถ้าน้องมีก้าไม่เข้าใจอะไร น้องมีก้าสามารถถามคุณครูได้\n'
                           '\n'
                           'ถ้าอยากเล่นกับเพื่อน น้องมีก้าสามารถพูดว่า\n'
                           '\n'
                           'Can I play with you?\n'
                           '\n'
                           'ถ้าเพื่อนกำลังใช้ของเล่นอยู่ น้องมีก้าสามารถรอ หรือเลือกเล่นอย่างอื่นก่อน\n'
                           '\n'
                           'ถ้าเกิดทำผิดพลาด น้องมีก้าพูดว่า\n'
                           '\n'
                           'Im sorry. I will try again.\n'
                           '\n'
                           'น้องมีก้าไม่จำเป็นต้องทำทุกอย่างให้สมบูรณ์แบบ\n'
                           '\n'
                           'สิ่งสำคัญคือ ลองทำ เรียนรู้ และลองใหม่\n'
                           '\n'
                           'ทุกครั้งที่น้องมีก้าทำอะไรด้วยตัวเองได้อีกหนึ่งอย่าง '
                           'น้องมีก้าก็เก่งขึ้นอีกนิดหนึ่ง\n'
                           '\n'
                           'คุณแม่ภูมิใจเวลาน้องมีก้าพยายาม ไม่ใช่เฉพาะเวลาน้องมีก้าทำสำเร็จ\n'
                           '\n'
    ...
    with library_cols[1]:
        st.markdown(
            ...
            <div class="soft-card" style="text-align:center;">
                ...
                <div class="muted">TPM, Chinese.</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
